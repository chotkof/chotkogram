...
//            }));
    ...
    private void setValue() {
        ...
        bioEdit.setText(currentBio = AyuLocalPremiumProfile.stripMarker(userFull.about));
    ...
    private void processDone(boolean error) {
        ...
        if (
            ...
            req1.flags |= 4;
            req1.about = AyuLocalPremiumProfile.withMarker(
                    bioEdit.getText().toString(),
                    user,
                    getMessagesController().getAboutLimit()
            );
            userFull.about = AyuLocalPremiumProfile.stripMarker(req1.about);
